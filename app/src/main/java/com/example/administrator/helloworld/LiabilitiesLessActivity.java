...
public class LiabilitiesLessActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_liabilities_less);

        //查询负债名称，并将数据显示在下拉框中
        CreateAssetsAndLiabilitiesDb createDb = new CreateAssetsAndLiabilitiesDb(LiabilitiesLessActivity.this);
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                db.execSQL(sql);
                //跳转到收支展示页面
                Intent intent=new Intent(LiabilitiesLessActivity.this,ShowIncomeAndExpenditureActivity.class);
